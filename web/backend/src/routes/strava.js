...
router.get('/callback', async (req, res) => {
  try {
    ...
    // state currently carries the user ID generated by the frontend.
    const userId = Number.parseInt(String(state), 10);
    ...
    const redirectBase = process.env.CORS_ORIGIN || 'http://localhost:3000';
    res.redirect(`${redirectBase}/settings?strava=connected`);
  } catch (error) {
